export default {
  // App
  'app.title': 'PiX',
  'app.subtitle': 'Editor de Partituras de Interacción',

  // Nav
  'nav.library': 'Biblioteca',
  'nav.editor': 'Editor',
  'nav.back': 'Volver a Biblioteca',
  'nav.about': 'Acerca de',

  // Library
  'library.title': 'Biblioteca de Partituras',
  ...
  'library.recordingsHint': 'Estas partituras provienen de la extensión PiX. Necesitan revisión: completar la capa de usuario, refinar el sistema, ajustar captions. Cuando estén listas, márcalas como finales.',
  'library.draftBadge': 'borrador',
  'library.draftHint': 'Grabación pendiente de refinamiento',
  'library.markFinal': 'Marcar como final',
  'library.reopenDraft': 'Reabrir como borrador',
  'library.walkthrough': 'Ver grabación',

  'walkthrough.backToLibrary': 'Volver a la biblioteca',
  'walkthrough.openInEditor': 'Abrir en editor',
  'walkthrough.stepOf': 'paso {current} de {total}',
  'walkthrough.prev': 'Paso anterior',
  'walkthrough.next': 'Paso siguiente',
  'walkthrough.crossing': 'cambio de sitio',
  'walkthrough.empty': 'Esta grabación no tiene pasos.',
  'walkthrough.noSnapshot': 'Este paso no tiene captura — fue agregado manualmente al partitura.',
  'walkthrough.scoreNotFound': 'Partitura no encontrada en la biblioteca.',
  'walkthrough.noTraceTitle': 'Esta partitura no tiene grabación asociada.',
  'walkthrough.noTraceHint': 'Si esperabas ver una grabación, ábrela desde la extensión PiX con "Open in editor" — eso transfiere los screenshots y la geometría de los clicks al editor.',
  'walkthrough.exportPdf': 'Exportar PDF',
  'walkthrough.exporting': 'Exportando…',
  'walkthrough.pdfStepHeader': 'Paso {current} de {total}',
  'walkthrough.pdfCapturedAt': 'Capturado',
  'library.edit': 'Editar',
  ...
  'library.importError': 'No se pudo importar el archivo. Asegúrate de que sea un JSON PiX válido.',
  ...
  // Editor
  'editor.untitled': 'Partitura sin título',
  'editor.descPlaceholder': 'Agrega una descripción...',
  ...
  // Layers
  'layer.user': 'Usuario',
  'layer.dialogue': 'Diálogo',
  'layer.system': 'Sistema',
  'layer.environment': 'Entorno',
  'layer.supporting': 'Procesos de Soporte',
  ...
  'step.gripTooltip': 'Click para más opciones',
  ...
  // Icon picker
  'picker.search': 'Buscar íconos...',
  'picker.suggested': 'Sugeridos',
  'picker.all': 'Todos los íconos',
  'picker.noResults': 'No se encontraron íconos',

  // Export
  'export.title': 'Exportar Partitura',
  'export.svg': 'SVG',
  'export.svgDesc': 'Imagen vectorial',
  'export.pdf': 'PDF',
  'export.pdfDesc': 'Documento vectorial',
  'export.png': 'PNG',
  'export.pngDesc': 'Imagen raster',
  'export.json': 'JSON',
  'export.jsonDesc': 'Archivo de datos',
  'export.downloadSection': 'Descargar partitura',
  'export.embedSection': 'Incrustar partitura',
  'export.iframe': 'HTML iframe',
  'export.iframeDesc': 'Código HTML para insertar en cualquier sitio web',
  'export.casiopea': 'Casiopea',
  'export.casiopeaDesc': 'Widget para la wiki Casiopea',
  'export.base64': 'Base64',
  'export.base64Desc': 'Datos codificados de la partitura',
  'export.close': 'Cerrar',
  'export.copy': 'Copiar',
  ...
  'viewer.openEditor': 'Abrir en Editor',
  'viewer.print': 'Imprimir',

  // About page
  'about.title': 'PiX — Partituras de Interacción',
  'about.lead': 'PiX es un sistema de notación visual para el diseño de interacción. Así como las partituras musicales describen la estructura temporal de una composición, las partituras de interacción describen la estructura temporal de una experiencia de usuario.',
  'about.notation.title': 'La Notación',
  'about.notation.intro': 'Una partitura de interacción tiene capas horizontales que representan diferentes actores y canales en una interacción:',
  'about.notation.user': 'Los estados emocionales y cognitivos de la persona',
  'about.notation.dialogue': 'Los elementos de interfaz y acciones — lo que el usuario ve y hace',
